...
public class Program {
    public static void main(String[] args) {
        ...
        produtos.Livro livro1 = new Livro("Duna", 2017, "Brasil", 56.30, 680, "Frank Herbert", 1);
        produtos.Livro livro2 = new Livro("Um de nós está mentindo", 2018, "Brasil", 34.93, 384,
                "Karen Mcmanus", 1);
        produtos.Livro livro3 = new Livro("Mindset Milionário", 2021, "Brasil", 31.70, 272,
                "José Roberto Marques", 1);

        produtos.Dvd dvd1 = new Dvd("Anjos da Noite 5 - Guerras de Sangue", 2016, "Estados Unidos", 16.90,
                "Anna Foerster",
                "Ação", 91);
        produtos.Dvd dvd2 = new Dvd("Annabelle 2 - A Criação do Mal", 2017, "Brasil", 39.90,
